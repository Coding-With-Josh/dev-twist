    ...
    <>
      <div className="h-[40rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        <Spotlight
          ...
          fill="white"
        />{' '}
        <div className="mt-8 flex flex-col items-center p-4 max-w-7xl  mx-auto relative z-10  w-full pt-20 md:pt-0">
          <Button
            className="px-4 bg-black/20 backdrop-blur-md py-2 flex items-center justify-center space-x-2 hover:bg-black/50 ease-in"
          >
            <Box size={16} />
          ...
          <ShimmerBtn 
            onClick={()=>router.push('/onboarding')}>Get Started</ShimmerBtn>
        </div>
      </div>
    </>
  );
